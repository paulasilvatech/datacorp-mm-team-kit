...
|---|---|---|
| **11:00–12:00** | Lê os programas atribuídos ao Par 5 e registra termos que apoiem o recorte | Evidências e termos relevantes |
| **13:30–14:00** | Consolida somente o vocabulário e as decisões necessários para a H1 | Apoio à feature fina |
| **14:00–15:00** | Revisa a clareza de `spec.md`, `plan.md` e `tasks.md`; registra decisão de escopo necessária | Artefatos formais consistentes |
| **15:00–16:10** | Documenta endpoints e comandos que o protótipo realmente criou | Documentação factual, quando aplicável |
